                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><div class="description-container">
                                ...
                                <a href="#" class="read-more">Read More</a></div></td>
                            <td>{{$data->harga}}</td>
                            <td>{{$data->wifi}}</td>
                            ...
                            <td>
                                <a class="btn btn-outline-warning" href="{{ url('halaman_update_kamar', $data->id) }}">Update</a>
                            </td>
                            <td>
                                <a onclick="return confirm('Apakah Anda Ingin Menghapus Kamar?')" 
                                class="btn btn-outline-danger" href="{{url('delete_kamar',$data->id) }}">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
